...
{
	if (region.V.F === region.ab.F)
	{
		return 'on line ' + region.V.F;
	}
	return 'on lines ' + region.V.F + ' through ' + region.ab.F;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.a5, request.bn, true);
		} catch (e) {
...
var $author$project$Main$GetYamlData = {$: 1};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{H: $elm$core$Maybe$Nothing, T: ''},
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					...
					function (_v1) {
						return $author$project$Main$GetYamlData;
					},
...
var $author$project$Main$GotYamlData = function (a) {
	return {$: 2, a: a};
};
var $author$project$Main$ParseYamlData = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$Section = F2(
	function (name, items) {
		return {an: items, G: name};
	});
var $author$project$Main$Item = F3(
	function (name, description, link) {
		return {aa: description, ap: link, G: name};
	});
...
var $author$project$Main$decodeItem = A4(
	$MaybeJustJames$yaml$Yaml$Decode$map3,
	F3(
		function (name, description, link) {
			return A3($author$project$Main$Item, name, description, link);
		}),
	...
	$MaybeJustJames$yaml$Yaml$Decode$maybe(
		A2($MaybeJustJames$yaml$Yaml$Decode$field, 'link', $MaybeJustJames$yaml$Yaml$Decode$string)));
...
var $author$project$Main$decodeSection = A3(
	...
	F2(
		function (name, items) {
			return A2($author$project$Main$Section, name, items);
		}),
	A2($MaybeJustJames$yaml$Yaml$Decode$field, 'name', $MaybeJustJames$yaml$Yaml$Decode$string),
	A2(
		$MaybeJustJames$yaml$Yaml$Decode$field,
		'items',
		$MaybeJustJames$yaml$Yaml$Decode$list($author$project$Main$decodeItem)));
var $author$project$Main$decodeYaml = A2(
	$MaybeJustJames$yaml$Yaml$Decode$field,
	'sections',
	$MaybeJustJames$yaml$Yaml$Decode$list($author$project$Main$decodeSection));
...
var $MaybeJustJames$yaml$Yaml$Parser$deadEndToString = function (deadend) {
	return 'Line ' + ($elm$core$String$fromInt(deadend.be) + (', column ' + ($elm$core$String$fromInt(deadend.l) + (': ' + $MaybeJustJames$yaml$Yaml$Parser$problemToString(deadend.bb)))));
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {l: col, aW: contextStack, bb: problem, be: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.be, s.l, x, s.c));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.be, s.l, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{l: newCol, c: s.c, p: s.p, b: newOffset, be: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _v0 = A5(_Parser_findSubString, str, s.b, s.be, s.l, s.a);
		var newOffset = _v0.a;
		var newRow = _v0.b;
		var newCol = _v0.c;
		...
		return A3(
			...
			0,
			{l: newCol, c: s.c, p: s.p, b: adjustedOffset, be: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$getCol = function (s) {
	return A3($elm$parser$Parser$Advanced$Good, false, s.l, s);
};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{l: col, c: s0.c, p: s0.p, b: offset, be: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.be, s.l, s);
	};
};
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{l: 1, c: s.c, p: s.p, b: s.b + 1, be: s.be + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{l: s.l + 1, c: s.c, p: s.p, b: newOffset, be: s.be, a: s.a}));
		};
	});
			...
			return $elm$parser$Parser$oneOf(
				_List_fromArray(
					[
						...
						$elm$parser$Parser$symbol('\n...\n')),
						_Utils_eq(actual, indent) ? next.N : ((_Utils_cmp(actual, indent) > 0) ? next.O(actual) : next.P)
					]));
		};
		return A2(
			$elm$parser$Parser$andThen,
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {a1: index, a4: match, a7: number, bi: submatches};
	});
...
var $MaybeJustJames$yaml$Yaml$Parser$listElementValue = function (indent) {
	...
	return A2(
		...
		indent,
		{
			M: $elm$parser$Parser$succeed($MaybeJustJames$yaml$Yaml$Parser$Ast$Null_),
			N: $elm$parser$Parser$succeed($MaybeJustJames$yaml$Yaml$Parser$Ast$Null_),
			O: function (indent_) {
				return $elm$parser$Parser$oneOf(
					_List_fromArray(
						[
			...
			P: $elm$parser$Parser$succeed($MaybeJustJames$yaml$Yaml$Parser$Ast$Null_)
		});
};
...
var $MaybeJustJames$yaml$Yaml$Parser$listStep = F2(
	function (indent, values) {
		...
		return A2(
			...
			indent,
			{
				M: $elm$parser$Parser$succeed(finish),
				N: $elm$parser$Parser$oneOf(
					_List_fromArray(
						[
							A2(
							$elm$parser$Parser$keeper,
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {l: col, bb: problem, be: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.be, p.l, p.bb);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{l: 1, c: _List_Nil, p: 1, b: 0, be: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{aR: false, aT: r.aT, aZ: r.aZ, ag: r.ag, a5: r.a5, bk: r.bk, aK: r.aK, bn: r.bn}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aT: $elm$http$Http$emptyBody, aZ: r.aZ, ag: _List_Nil, a5: 'GET', bk: $elm$core$Maybe$Nothing, aK: $elm$core$Maybe$Nothing, bn: r.bn});
};
var $author$project$Main$msgToCmd = F2(
	function (toMsg, arg) {
		return A2(
			$elm$core$Task$perform,
			toMsg,
			$elm$core$Task$succeed(arg));
	});
		...
		switch (msg.$) {
			...
			case 1:
				return _Utils_Tuple2(
					...
					$elm$http$Http$get(
						{
							aZ: $elm$http$Http$expectString($author$project$Main$GotYamlData),
							bn: '/data.yml'
						}));
			case 2:
				var res = msg.a;
				if (!res.$) {
					var yamlString = res.a;
					return _Utils_Tuple2(
						_Utils_update(
							appState,
							{T: yamlString}),
						A2($author$project$Main$msgToCmd, $author$project$Main$ParseYamlData, yamlString));
				} else {
					return _Utils_Tuple2(appState, $elm$core$Platform$Cmd$none);
				}
			default:
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$viewItems(section.an))
			]));
};
...
var $author$project$Main$view = function (appState) {
	return _Utils_eq(appState.H, $elm$core$Maybe$Nothing) ? $author$project$Main$pageWrapper(
		A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
